...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<h2 style='text-align: center; margin-top: 20px;'>Terima kasih, ini adalah data yang Anda kirim:</h2>";
...
<h2 style="text-align: center;">Formulir Kontak</h2>
